...
if Answer == 0:
    ...
    skip = int(raw_input("How many characters do you want to skip after every sequence while training?: "))
    skip = skip + 1
...
if Answer != 0:
    try:
        ...
        skip = int(raw_input("How many characters do you want to skip after every sequence while training?: (I hope, you remember what it was): "))
...
if Answer == 0 or Answer == 2:
    ...
    for i in xrange(0,total_chars-seq_len,skip):  # Example of an extract of dataset: Language 
...
if Answer == 0 or Answer == 2:
    ...
    for iteration in range(1,60):
        ...
        model.save_weights('GRUWeightsX.h5') # Saving current model state so that even after terminating the program; training
